                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-dark"><?php echo $total_organisasi; ?></h3>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-dark"><?php echo $total_anggota; ?></h3>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-dark"><?php echo $total_pending; ?></h3>
                            </div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-center text-center p-5">
                        <?php if ($total_pending > 0): ?>
                            <div class="w-100">
                                ...
                                <a href="index.php?action=kelola_pendaftaran" class="btn btn-primary px-4">Lihat Daftar</a>
                            </div>
                        <?php else: ?>
                            <div>
            ...
            <div class="col-lg-5">
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-6">
                                <a href="index.php?action=organisasi" class="card text-decoration-none btn-quick-action border-primary text-primary">
                                    <i class="fas fa-university fa-2x mb-2"></i>
                                    <span class="small">Kelola Organisasi</span>
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="#" class="card text-decoration-none btn-quick-action border-success text-success">
                                    <i class="fas fa-clipboard-list fa-2x mb-2"></i>
                                    <span class="small">Kelola Pendaftaran</span>
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="#" class="card text-decoration-none btn-quick-action border-warning text-warning">
                                    <i class="fas fa-plus-circle fa-2x mb-2"></i>
                                    <span class="small">Tambah Organisasi</span>
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="#" class="card text-decoration-none btn-quick-action border-info text-info">
                            ...
                            <div class="col-12">
                                <a href="#" class="card text-decoration-none btn-quick-action border-dark text-dark" style="height: 60px; flex-direction: row;">
                                    ...
                                    <span class="small">Tambah Anggota</span>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    // Query log aktivitas (Limit 15 sesuai permintaan)
                                    ...
                                    <?php 
                                        ...
                                        foreach ($logs as $log):
                                            // LOGIKA WARNA BADGE
                                            $bgBadge = 'bg-primary'; // Default Biru
                                            if (strpos($log['aktivitas'], 'Hapus') !== false) $bgBadge = 'bg-danger'; // Merah
                                            if (strpos($log['aktivitas'], 'Update') !== false) $bgBadge = 'bg-warning text-dark'; // Kuning
                                            if (strpos($log['aktivitas'], 'Daftar') !== false) $bgBadge = 'bg-success'; // Hijau
                                    ?>
                                        <tr>
